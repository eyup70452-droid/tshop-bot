...
export const VIP_BENEFITS = {
  [VIP_LEVELS.STANDARD]: {
    ...
    transferTaxRate: 0.01, monthlyGift: 0,
  },
  [VIP_LEVELS.PRO]: {
    ...
    transferTaxRate: 0.005, monthlyGift: 500,
  },
  [VIP_LEVELS.MAX]: {
    name: "Max VIP", icon: "👑", frame: "frame-diamond",
    wheelRewards: [20, 40, 60, 90, 130, 160, 190, 230, 270, 325, 380, 420],    wheelBelowChance: 0.70, boostProducts: 28, boostDays: 8,
    transferTaxRate: 0, monthlyGift: 1500,
  },
};
...
export const BADGES_DEF = [
  ...
  { id: 'rich', name: 'Zengin', icon: '💎', desc: '5000 TS biriktir', condition: (u: any) => u?.points >= 5000, xp: 500, tier: 'B' },  { id: 'social', name: 'Sosyal', icon: '🗣️', desc: '5 Yorum yap', condition: (u: any) => u?.stats?.reviewsWritten >= 5, xp: 150, tier: 'D' },
...
const createInitialDB = () => {
  ...
  return {
    ...
    users: [
      {
        ...
        stats: { orders: 0, tasksCompleted: 0, reviewsWritten: 0, favorites: 0, spent: 0, earned: 0, gamesPlayed: 0, biggestWin: 0, itemsSold: 0, currentStreak: 0, longestStreak: 0, flashPurchases: 0 },
      ...
      },
      {
        ...
        vipLevel: VIP_LEVELS.MAX, vipExpiresAt: now + 365 * 86400000,        stats: { orders: 0, tasksCompleted: 0, reviewsWritten: 0, favorites: 0, spent: 0, earned: 0, gamesPlayed: 0, biggestWin: 0, itemsSold: 0, currentStreak: 0, longestStreak: 0, flashPurchases: 0 },
      ...
      },
      {
        ...
        stats: { orders: 0, tasksCompleted: 0, reviewsWritten: 0, favorites: 0, spent: 0, earned: 45000, gamesPlayed: 0, biggestWin: 0, itemsSold: 142, currentStreak: 0, longestStreak: 0, flashPurchases: 0 },
    ...
    tasks: [
      ...
      { id: 't4', title: "İlk Yorumunu Yap", reward: 40, category: "Topluluk", repeatable: false, icon: "💭", description: "Bir ürüne yorum yaz", verifyType: 'auto' },      { id: 't5', title: "Arkadaş Davet Et", reward: 100, category: "Referans", repeatable: true, cooldown: 86400000 * 7, icon: "👥", description: "Arkadaşını davet et", verifyType: 'auto' },
    ] as any[],
  ...
  persist(
    ...
    }),
    {
      ...
      partialize: (state) => ({
        ...
        vipPrices: state.vipPrices,
        topUpPackages: state.topUpPackages,
      }),
    }
  )
);
