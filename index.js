    ...
    <script>
        ...
        loginBtn.addEventListener('click', async () => {
            ...
            if (!tg || !tg.initDataUnsafe?.user) {
                showMessage("Hata: Bu siteye direkt tarayıcıdan değil, Telegram botunuzun açtığı Mini App içinden girmelimisiniz!", "error");
                return;
            }
...
// Hata düzelttildi: Parantez kapatıldı.
